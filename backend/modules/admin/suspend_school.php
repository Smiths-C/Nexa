<?php
// تعلیق مدرسه: اطلاعات دست‌نخورده می‌مونه ولی هیچ‌کس (مدیر/معلم/دانش‌آموز) نمی‌تونه
// وارد بشه یا کاری انجام بده، تا وقتی ادمین دوباره فعالش کنه.
...
Response::json(['success' => true, 'message' => 'مدرسه تعلیق شد؛ اطلاعاتش حفظ می‌مونه']);
